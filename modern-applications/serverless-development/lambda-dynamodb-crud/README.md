...
This lab demonstrates building foundational serverless applications with AWS Lambda and DynamoDB. You'll create Lambda functions that perform CRUD operations on a DynamoDB table and integrate with an S3-hosted static website.
