...
This project demonstrates building a **real-time streaming data pipeline** using Amazon Kinesis services. The system processes continuous data streams from DynamoDB, transforms the data with Lambda, and delivers it to OpenSearch for real-time analytics and visualization.
