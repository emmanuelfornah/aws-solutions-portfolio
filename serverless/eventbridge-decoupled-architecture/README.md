...
This project demonstrates building a **pizza ordering system** using event-driven architecture with Amazon EventBridge. The system showcases how to create loosely coupled microservices that communicate through events, enabling scalability, flexibility, and real-time updates via WebSocket connections.
...
This project implements a decoupled pizza ordering system where components communicate exclusively through events:
