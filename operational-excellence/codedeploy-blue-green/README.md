...
- **Manual**: You control when to reroute (recommended for this lab)
...
- **AWS Certified Developer Associate**: CodeDeploy deployment strategies, blue/green deployments
- **AWS Certified Solutions Architect Associate**: High availability architectures, load balancing, Auto Scaling
- **AWS Certified DevOps Engineer Professional**: Advanced deployment strategies, CI/CD pipelines, zero-downtime deployments
