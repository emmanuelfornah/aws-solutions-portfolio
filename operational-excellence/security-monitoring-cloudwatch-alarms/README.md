...
- **AWS Certified Cloud Practitioner**: CloudWatch basics, monitoring concepts
- **AWS Certified Solutions Architect Associate**: CloudWatch architecture, alarm design, Auto Scaling integration
- **AWS Certified SysOps Administrator Associate**: Operational monitoring, alarm management, troubleshooting
