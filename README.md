...
- **[AI/ML Applications](./ai-ml-applications/)** - Generative AI, Foundation Models, LangChain, RAG
  ...
  - Production-ready AI applications for modern cloud developer roles
...
- [Compute](./compute/) - EC2, Lambda, Elastic Beanstalk
- [Storage](./storage/) - S3, EBS, EFS
- [Databases](./databases/) - RDS, DynamoDB, Database Migration
- [Networking](./networking/) - VPC, CloudFront, Load Balancing
- [Security](./security/) - IAM, WAF, KMS, Inspector
...
- [Skills Matrix](./SKILLS_MATRIX.md) - AWS services and competency levels
